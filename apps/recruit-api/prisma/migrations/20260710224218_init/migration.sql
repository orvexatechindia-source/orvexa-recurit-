-- CreateEnum
CREATE TYPE "SaasRole" AS ENUM ('SUPER_ADMIN', 'CLIENT_ADMIN', 'RECRUITER', 'HIRING_MANAGER', 'CANDIDATE');

-- CreateEnum
CREATE TYPE "JobStatus" AS ENUM ('DRAFT', 'PUBLISHED', 'CLOSED');

-- CreateEnum
CREATE TYPE "ApplicationStatus" AS ENUM ('APPLIED', 'SCREENING', 'INTERVIEWING', 'OFFER', 'REJECTED', 'HIRED');
...
CREATE TABLE "users" (
    ...
    "name" TEXT NOT NULL,
    "role" "SaasRole" NOT NULL DEFAULT 'CANDIDATE',
