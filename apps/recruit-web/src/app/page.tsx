    ...
    <DashboardLayout>
      ...
      <div className="grid gap-6 md:grid-cols-3">
        <Card className="border border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0B1220]">
          ...
          <CardContent>
            <p className="text-4xl font-extrabold text-[#046bd2] dark:text-cyan-400 font-display">0</p>
        ...
        <Card className="border border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0B1220]">
          ...
          <CardContent>
            <p className="text-4xl font-extrabold text-cyan-500 dark:text-cyan-400 font-display">0</p>
        ...
        <Card className="border border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0B1220]">
          ...
          <CardContent>
            <p className="text-4xl font-extrabold text-slate-900 dark:text-white font-display">0</p>
